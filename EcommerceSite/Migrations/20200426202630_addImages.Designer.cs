...
namespace EcommerceSite.Migrations
{
    ...
    [Migration("20200426202630_addImages")]
            ...
            modelBuilder.Entity("EcommerceSite.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            FK_CategoryId = 1,
                            FK_SellerId = "b8e2598f-fb76-4658-88aa-a9fa0be23189",
                            LongDisc = "The iPhone X was Apple's flagship 10th anniversary iPhone featuring a 5.8-inch OLED display, facial recognition and 3D camera functionality, a glass body, and an A11 Bionic processor. Launched November 3, 2017, discontinued with the launch of the iPhone XR, XS, and XS Max.",
                            Name = "IPhone X",
                            Price = 20000f,
